<template>
  <div class="card mt-4 likeCard" style="border-radius: 20px; transform: rotate(2deg)">
    <h5 class="card-header" style="border-top-right-radius: 20px; border-top-left-radius: 20px"
      ...
      Likes
      <SuperColorPicker icon="newspaper" button-color="dark" base-color="#f7f7f7" @color-changed="changelikeHeaderColor"
        class="to-exclude" />
      <SuperColorPicker icon="font" button-color="light" base-color="#000000" @color-changed="changelikeTitleColor"
        class="to-exclude" />
    </h5>
    <div class="card-body px-3 pt-2 pb-3" :style="{ 'background': likeBackgroundColor }"
      ...
      <SuperColorPicker icon="chess-board" button-color="dark" base-color="#ffffff"
        @color-changed="changelikeBackgroundColor" class="to-exclude" />
      <div class="likes">
